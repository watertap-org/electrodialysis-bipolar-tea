...
def cost_bipolar_electrodialysis(blk, cost_electricity_flow=True, has_rectifier=False, has_bp_acid_value=False,
        ...
        blk.capital_cost_constraint = pyo.Constraint(
            ...
            * (
                pyo.units.convert(
                    ...
                    * (2 * blk.unit_model.cell_width * blk.unit_model.cell_length * blk.unit_model.electrical_stage_num),
